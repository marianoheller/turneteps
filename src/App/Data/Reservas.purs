module App.Data.Reservas (Reservas(..), Reserva(..), ReservaData, groupPerDate) where
...
groupPerDate :: Reservas -> Map Date Reservas
groupPerDate (Reservas reservas) =
  let
    mapper c@(Reserva r) = Tuple (toDate r.fechaHora) (singleton c)
  in
